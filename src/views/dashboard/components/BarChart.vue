      ...
      this.chart.setOption({
        tooltip: {
          ...
          formatter: function (params) {
            var showHtm = ''
            showHtm += '<i style="display: inline-block;width: 8px;height: 8px;background-color: rgba(0,199,248,0.87);margin-right: 8px;border-radius: 50%;"></i>' + params[0].name + '&nbsp;&nbsp;&nbsp;&nbsp;' + params[0].value + '人'
            return showHtm
          }
        },
        grid: {
