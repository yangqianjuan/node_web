  ...
  <div class="visitRecord">
    <div class="app-container">
      ...
      <div class="table-prefix-bars">
        <span class="table-tile">顾客人次列表</span><span class="table-tile-total">共{{page.total}}条</span>
      </div>
...
<script>
import { getVisitRecord, getSearchCondition, getCameraOption, getShopOption } from '@/api/statistics'
...
export default {
  ...
  created() {
    ...
    if (this.$route.query.userId === '' || this.$route.query.userId === undefined) {
      ...
      this.link = true
      this.search.customerId = this.$route.query.userId
      this.filterOptions = [{ value: this.$route.query.userId, name: this.$route.query.name }]
    }
    if (this.$route.query.camera === '' || this.$route.query.camera === undefined) {
      this.search.camera === ''
    } else {
